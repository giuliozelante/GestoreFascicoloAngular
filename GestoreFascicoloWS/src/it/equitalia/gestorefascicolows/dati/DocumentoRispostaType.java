...
public class DocumentoRispostaType  implements java.io.Serializable {
    ...
    public DocumentoType getDocumento(int i) {
        return this.documento[i];
    }

    public void setDocumento(int i, DocumentoType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "DocumentoRispostaType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "TotaleDaPagare"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "TotaleDaPagarePagina"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "Documento"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "DocumentoType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
