...
public class PianoRateazioneType  implements java.io.Serializable {
    ...
    private EnteType enteConcedente;

    private java.lang.String statoPiano;

    private RataType[] rata;
     ...
     */
    public EnteType getEnteConcedente() {
        return enteConcedente;
    }
     ...
     */
    public void setEnteConcedente(EnteType enteConcedente) {
        this.enteConcedente = enteConcedente;
    }
     ...
     * @param rata
     */
    public void setRata(RataType[] rata) {
        this.rata = rata;
    }

    public RataType getRata(int i) {
        return this.rata[i];
    }

    public void setRata(int i, RataType _value) {
        this.rata[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "PianoRateazioneType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "DataApprovazione"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "EnteConcedente"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "StatoPiano"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("rata");
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "Rata"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "RataType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://dati.backend.gestorefascicolows.equitalia.it", "Protocollo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
