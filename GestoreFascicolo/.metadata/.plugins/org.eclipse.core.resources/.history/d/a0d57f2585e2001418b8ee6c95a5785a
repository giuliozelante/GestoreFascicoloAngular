...
public class GetFascicoloWSRequest  implements java.io.Serializable {
    private java.lang.String fascicoloId;

    private java.lang.String callerId;

    public GetFascicoloWSRequest() {
    }
    ...
    /**
     * Gets the fascicoloId value for this GetFascicoloWSRequest.
     * 
     * @return fascicoloId
     */
    ...
    /**
     * Sets the fascicoloId value for this GetFascicoloWSRequest.
     * 
     * @param fascicoloId
     */
    ...
    /**
     * Gets the callerId value for this GetFascicoloWSRequest.
     * 
     * @return callerId
     */
    ...
    /**
     * Sets the callerId value for this GetFascicoloWSRequest.
     * 
     * @param callerId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetFascicoloWSRequest)) return false;
        GetFascicoloWSRequest other = (GetFascicoloWSRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetFascicoloWSRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.gestorefascicolows.equitalia.it", ">getFascicoloWSRequest"));
