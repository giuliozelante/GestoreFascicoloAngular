...
public class InsertIndirizzoWSRequest  implements java.io.Serializable {
    ...
    public InsertIndirizzoWSRequest() {
    }
    ...
    /**
     * Gets the fascicoloId value for this InsertIndirizzoWSRequest.
     * 
     * @return fascicoloId
     */
    ...
    /**
     * Sets the fascicoloId value for this InsertIndirizzoWSRequest.
     * 
     * @param fascicoloId
     */
    ...
    /**
     * Gets the callerId value for this InsertIndirizzoWSRequest.
     * 
     * @return callerId
     */
    ...
    /**
     * Sets the callerId value for this InsertIndirizzoWSRequest.
     * 
     * @param callerId
     */
    ...
    /**
     * Gets the indirizzo value for this InsertIndirizzoWSRequest.
     * 
     * @return indirizzo
     */
    ...
    /**
     * Sets the indirizzo value for this InsertIndirizzoWSRequest.
     * 
     * @param indirizzo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InsertIndirizzoWSRequest)) return false;
        InsertIndirizzoWSRequest other = (InsertIndirizzoWSRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InsertIndirizzoWSRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dati.gestorefascicolows.equitalia.it", ">insertIndirizzoWSRequest"));
